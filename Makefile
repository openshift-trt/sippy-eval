...
.PHONY: verify apm verify-apm mcp-venv mcp-test
...
ifeq ($(ARTIFACT_DIR),)
	cd mcp; .venv/bin/pytest test_server.py -v --junitxml=../mcp-junit.xml
else
	cd mcp; .venv/bin/pytest test_server.py -v --junitxml=$(ARTIFACT_DIR)/mcp-junit.xml
endif
