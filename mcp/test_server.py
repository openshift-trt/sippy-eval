...
class TestDataMode:
    def _patch_dotenv(self, vals):
        ...
        env_mock = stack.enter_context(mock.patch("server._DEVCONTAINER_ENV"))
        env_mock.is_file.return_value = True
        stack.enter_context(mock.patch("server.dotenv_values", return_value=vals))
        return stack
